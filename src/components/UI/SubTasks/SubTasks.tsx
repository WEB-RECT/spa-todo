...
const SubTasks: FC<IProps> = ({tasks, type = 'change', onChange}) => {
    ...
    const [currentEditSubTask, setCurrentEditSubTask] = useState<number | null>(null)
                                    ...
                                    currentEditSubTask === index
                                        ...
                                        <div className={styles.rowEdit}>
                                            <Input
                                                ...
                                                onChange={(e) => setValueEditSubTask(e.target.value)}
                                            />
                                            <div className={styles.events}>
                                                <div
                                                    className={styles.eventsItem}
                                                    onClick={() => setCurrentEditSubTask(null)}
                                                >
                                                    <CloseOutlined/>
                                                </div>
                                                <div
                                        ...
                                        <Checkbox
                                            checked={item.status}
                                            onChange={(e) => changeStatusSubTask(index, e.target.checked)}
                                        >
                                            {
                                                item.text
                                            }
